...
Esta es una muestra de nueve ejercicios de lógica de JavaScript. 
He aquí la explicación de cada ejercicio. Puede ejecutar los ejercicios ingresando el número correspondiente en el link. 
